...
if(data == 'now'){
 ...
 id2=['YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin']
    ...
    id=['山手学院','山手学院','山手学院','山手学院','山手学院','山手学院','山手学院','山手学院','山手学院','山手学院','電車','山手学院'];
    id2=['YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','Train','YamateGakuin'];
}else if(data == "date"){
    e_d = data;
    j_d = "二人の時間";
    ...
    id2=['YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','YamateGakuin','Ofuna ','Ofuna','Gusto']
}
